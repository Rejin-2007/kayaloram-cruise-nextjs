...
export default function AboutInformation() {
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        {/* Background Effects (non-interactive, no hydration cost) */}
        <div
          className="pointer-events-none absolute -left-25 -bottom-30 h-100 w-100 rounded-full bg-emerald-400/50 blur-[90px]"
          aria-hidden="true"
        />
        <div
          className="pointer-events-none absolute -right-40 -top-30 h-80.5 w-92.5 rounded-full bg-green-200/50 blur-2xl"
          aria-hidden="true"
        />
